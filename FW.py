...
作者：陈欣如
日期：2022年09月16日
python FW.py --seed 2022 --model_num 2 --train_length 100 --dataset '001-2014' --classes 4 --person 1 --model_type 'EEGNet' --model_save_path /model/EEGNet-001-2014-4/within_overlap/ --gpu_id 
'3'
'''
import numpy as np
import os
...
if __name__ == '__main__':
    ...
    if args.dataset == "001-2014" and class_num == 4:
        ...
        print("acc:", np.round(np.array(correct_num / total_num), decimals=4))
